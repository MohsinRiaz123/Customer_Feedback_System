                ...
                <div class="container w-full mx-auto">
                    <div class="flex items-center justify-between py-2  ">
                        ...
                        <div class="hidden sm:flex sm:items-center">
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">Dashboard</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">About Us</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-blue-600 mr-4">Contect Us</a>
                        </div>
                    ...
                    <div class="block sm:hidden bg-white border-t-2 py-2">
                        <div class="flex flex-col">
                            <a href="/dashboard" class="text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">Dashboard</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">About Us</a>
                            <a href="#" class="text-gray-800 text-sm font-semibold hover:text-blue-600 mb-1">Contect Us Us</a>
                            <div class="flex  items-center border-t-2 pt-2">
                                <a href="#" class="text-gray-800 text-sm font-semibold border px-4 py-1 rounded-lg hover:text-blue-600 hover:border-blue-600">Log Out</a>
                            </div>
                        </div>
                    </div>
                </div>
